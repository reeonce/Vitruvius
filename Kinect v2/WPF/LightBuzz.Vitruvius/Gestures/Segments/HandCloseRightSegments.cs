    ...
    class HandCloseRightSegment : IGestureSegment
    {
        ...
        public GesturePartResult Update(Body body)
        {
            if (body.HandRightState == HandState.Closed)
            {
                ...
                if (body.Joints[JointType.HandRight].Position.X > body.Joints[JointType.ShoulderRight].Position.X && body.Joints[JointType.HandRight].Position.Y > body.Joints[JointType.ElbowRight].Position.Y && (body.Joints[JointType.HandRight].Position.X < body.Joints[JointType.ElbowRight].Position.X))
                {
                    ...
                    if (body.Joints[JointType.HandRight].Position.Z > body.Joints[JointType.ShoulderRight].Position.Z - bodyHeight * 0.3)
                    {
